...
export function Header() {
    ...
    return (
        <header>
            <div className={`${styles['headerContainer']} ${styles[dark ? 'darkContainer' : "lightContainer"]}`} >
                <Link passHref href="/">
                ...
                <div>
                    ...
                    <Button variant="subtle" onClick={() => dispatch({ type: "TOGGLE", payload: { open: !open } })} className={styles["drawerButton"]} >
